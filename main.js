...
let sockets = [];
let getGenesisBlock = () => {
    return new Block(0, "0", 1465154705, "my genesis block!!", "5f5f34932c2b7154836da6afc367695e6337db8a92d6tgdhe78876ue8u4e7ye");
};
...
let appServer = () => {
	...
	app.post('/addPeer', (req, res) => {
        ...
        res.send(sockets.map(s => s._socket.remotePort));
    });    
...
appServer();
peerServer();
nw.Window.open('index.html', {"min_width": 400,"min_height": 400}, function(win) {});
